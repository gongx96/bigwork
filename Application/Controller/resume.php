...
//return;
$sql_id="select * from resume where userid={$id}";
...
//}
if($res_id->fetch_row()){
    $sql1="select `name`,phone,email from user where id={$id}";
    $res1=$conn->query($sql1);
...
//        echo  json_encode($rows1);
    ...
    $sql2="select sex,salary,work_time,introduce,birthday from resume where userid={$id}";
